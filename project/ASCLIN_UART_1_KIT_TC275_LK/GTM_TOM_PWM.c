...
void initGtmTomPwm(void)
{
    ...
    /* Initialize the configuration structure with default parameters */  //初始化LED的TOM的PWM配置
    ...
    IfxGtm_Tom_Pwm_initConfig(&g_tomConfig2, &MODULE_GTM);          //初始化LED2的TOM的PWM的配置
...
void fadeLED(void)
{
    ...
    setDutyCycle(1, g_fadeValue);                                      /* Set the duty cycle of the PWM                */
}
